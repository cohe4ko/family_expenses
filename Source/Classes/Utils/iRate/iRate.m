...
- (iRate *)init
{
	if ((self = [super init]))
	{
		...
		self.cancelButtonLabel = @"Нет, спасибо";
		self.remindButtonLabel = @"Напомнить позже";
		self.rateButtonLabel = @"Оставить отзыв";
	}
	return self;
}
...
- (NSString *)messageTitle
{
	...
	return [NSString stringWithFormat:@"Оставить отзыв %@", applicationName];
}
